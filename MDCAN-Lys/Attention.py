...
class Attention(Layer):
    ...
    def __init__(self, hidden, init='glorot_uniform', activation='linear', W_regularizer=None, W0_regularizer=None,
                 W_constraint=None, W0_constraint=None, **kwargs):
    ...
    def build(self, input_shape):
        ...
        self.W0 = self.add_weight(shape=(input_dim, self.hidden), name='W0', initializer=self.init,
                                  regularizer=self.W0_regularizer, constraint=self.W0_constraint)
        self.W = self.add_weight(shape=(self.hidden, 1), name='W', initializer=self.init,
